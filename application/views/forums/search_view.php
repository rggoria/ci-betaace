...
<div class="container">
  <div class="m-3">
    <a href="<?php echo site_url('Forums/add_post'); ?>" class="input-group" style="text-decoration: none;">      
      <input type="text" class="form-control" style="cursor: pointer;" placeholder="Share your discussion..." disabled>
...
<div class="container">
  <h4>
    <span class="fa fa-search">&nbsp;Searched Result:</span>
    <?php if($total != 0): ?>
      <span class="badge alert-primary"><?= $total; ?></span>
    <?php else: ?>
      <span class="badge alert-danger"><?= $total; ?></span>
    <?php endif; ?>
  </h4>
  <!-- Discussion Details -->
